...
description: >
  ...
  페어 gil-commerce:commerce-copywriting과 명확히 구분 — 본 스킬은 범용, 페어는 이커머스 운영 (광고·톡톡·푸시·이메일·카트 이탈) 전용.
...
- `gil-content:blog` — SEO 블로그 포스팅 작성
- `gil-content:card-news` — 인스타그램 카드뉴스 제작
- `gil-content:newsletter` — 이메일 뉴스레터 기획
- `gil:ai-slop-reviewer` — AI 생성 텍스트 패턴 검수