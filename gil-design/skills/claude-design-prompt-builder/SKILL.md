...
description: |
  [한·UZ 듀얼] Claude Design용 시니어 UX 프롬프트를 10가지 전문 패턴(정보 구조·디자인 시스템·카피·온보딩·접근성·대시보드·폼·테스트·휴리스틱·리서치) 중 적합한 것을 골라 완성해 줍니다.
  ...
  - "디자인 시스템 프롬프트"
  - "프롬프트 빌더"
  (UZ 추가 트리거: "UZ 다국어 UX 프롬프트", "트릴링구얼 접근성 프롬프트")
user-invocable: true
version: 1.0.1
---
...
- 카피 검수 필요 → gil-design:claude-design-slop-check
```
...
| 스킬 | 사용 시점 |
|---|---|
| `gil-design:claude-design-brief` | 대안: 일반적 6요소 브리프 (시니어 패턴이 필요 없을 때) |
| `gil-design:claude-design-system-prep` | 선행: 디자인 시스템 자산 합성 |
| `gil-design:claude-design-slop-check` | 후속: 결과 카피 검수 |
| `gil-product:ux-designer` | 보조: Claude Design 외 UX 분석 |
| `gil-product:ux-researcher` | 보조: 사용자 리서치 단계 |
