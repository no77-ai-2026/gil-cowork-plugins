...
description: |
  [책임 경계] 상품명 3안 자동 생성 + 플랫폼 검증 (스마트스토어·쿠팡·네이버쇼핑 25자·금지어). 페어 스킬 gil-commerce:commerce-copywriting과 명확히 구분 — 본 스킬은 상품 등록용 상품명(SEO 최적화), 페어는 광고·마케팅 카피.
...
- **광고 카피·헤드라인 생성**: `gil-commerce:commerce-copywriting` 또는 `detail-page-copy` 사용
