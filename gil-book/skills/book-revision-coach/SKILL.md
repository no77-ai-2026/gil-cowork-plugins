...
> 💡 본 스킬은 1차 점검만 수행. 정밀 맞춤법은 `gil-content:korean-spell-check`(바른한글) 체이닝 권장.
...
1차 어법·문체·논리 (book-revision-coach) ← 본 스킬
  ↓
정밀 맞춤법 (gil-content:korean-spell-check, 바른한글)
  ↓
AI 티 윤문 (gil-content:humanize-korean) ← 필수
  ↓
...
### After (체이닝 — 4 체인 권장)
- `gil-content:korean-spell-check` — 정밀 한국어 맞춤법
- `gil-content:humanize-korean` — AI 티 정밀 윤문 (필수)
- `gil:ai-slop-reviewer` — 최종 검수 (필수)
- `book-proposal-writer` — 검수 완료 후 출판사 투고 제안서로

### Alternative
- `gil-content:korean-spell-check` 단독 — 빠른 맞춤법만
