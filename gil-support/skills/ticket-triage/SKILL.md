...
| korean-tone-reviewer | gil-hr | 한국어 문서 어투·경어 검수 |

## 이 스킬을 사용하지 말아야 할 때

- **고객 응답 초안 작성** → gil-support:draft-response 스킬이 더 적합합니다
- **에스컬레이션 처리 및 VIP 대응** → gil-support:escalation-manager 스킬을 사용하세요
